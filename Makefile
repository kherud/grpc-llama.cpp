...
all: system-check llm_client llm_server

llm_client: llm.pb.o llm.grpc.pb.o llm.o
	$(CXX) $^ $(LDFLAGS) -o $@

llm_server: llm.pb.o llm.grpc.pb.o llm_server.o
	$(CXX) $^ $(LDFLAGS) -o $@
...
clean:
	rm -f *.o *.pb.cc *.pb.h llm_client llm_server
